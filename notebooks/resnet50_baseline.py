...
from utils import evaluate_retrieval, score
...
data_folder = f"/home/disi/ml-project/data/{split}"
print(f"Split: {split}")
...
# instead of submit() results are saved as a json file and evaluate score with utils.py

output_file = f'../results/baseline_{split}.json'
...
print(f"Baseline Results on {split} split ---")
